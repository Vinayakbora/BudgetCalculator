...
val WhiteThree = Color(0xfff4f4f4)
val PrimaryContainer = Color(0xff0074c9)
val LatoRegular = Color(0xff666666)
val NewContainer = Color(0xffe8f6ff)
val MintTulip  = Color(0xffb4f0e9)
val Aztec  = Color(0xff091717)
val Juniper  = Color(0xff699794)